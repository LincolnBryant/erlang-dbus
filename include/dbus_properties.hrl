...
-define(DBUS_PROPERTIES_GET, #dbus_method{
    name = 'Get',
    args = [
        #dbus_arg{name = 'interface_name', type = <<"s">>},
        #dbus_arg{name = 'property_name', type = <<"s">>}
    ],
    result = #dbus_arg{name = 'value', direction = out, type = <<"v">>},
    in_sig = <<"ss">>,
    in_types = [string, string]
}).

-define(DBUS_PROPERTIES_SET, #dbus_method{
    name = 'Set',
    args = [
        #dbus_arg{name = 'interface_name', type = <<"s">>},
        #dbus_arg{name = 'property_name', type = <<"s">>},
    ...
    in_sig = <<"ssv">>,
    in_types = [string, string, variant]
}).

-define(DBUS_PROPERTIES_GET_ALL, #dbus_method{
    name = 'GetAll',
...
-define(DBUS_PROPERTIES_PROPERTIES_CHANGED, #dbus_signal{
    ...
    out_sig = <<"s{sv}as">>,
    out_types = [string, {dict, string, variant}, {array, string}]
}).

-define(DBUS_PROPERTIES, #dbus_iface{
    name = ?DBUS_IFACE_PROPERTIES,

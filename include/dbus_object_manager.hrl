...
%-include("dbus.hrl").
%
%-define(DBUS_OBJECT_GET_MANAGED_OBJECTS, #dbus_method{
...
%}).
%
%-define(DBUS_OBJECT_INTERFACES_ADDED, #dbus_signal{
%    name = 'InterfacesAdded',
%    args = [
%        #dbus_arg{name = 'object_path', type = <<"o">>},
%        #dbus_arg{name = 'interfaces', type = <<"{s{sv}}">>}
%    ],
%    out_sig = <<"o{s{sv}}">>,
%    out_types = [object_path, {dict, string, {dict, string, variant}}]
%}).
%
%-define(DBUS_OBJECT_INTERFACES_REMOVED, #dbus_signal{
...
%    ],
%    out_sig = <<"oas">>,
%    out_types = [object_path, {array, string}]
%}).
%
%-define(DBUS_OBJECT_MANAGER_IFACE, 'org.freedesktop.DBus.ObjectManager').
%
%-define(DBUS_OBJECT_MANAGER, #dbus_iface{

...
-define(DBUS_DBUS_HELLO, #dbus_method{
    name = 'Hello',
    args = [],
...
-define(DBUS_DBUS_LIST_NAMES, #dbus_method{
    name = 'ListNames',
    args = [],
...
-define(DBUS_DBUS_LIST_ACTIVATABLE_NAMES, #dbus_method{
...
-define(DBUS_DBUS_NAME_HAS_OWNER, #dbus_method{
    name = 'NameHasOwner',
...
-define(DBUS_DBUS_NAME_OWNER_CHANGED, #dbus_signal{
    name = 'NameOwnerChanged',
    args = [
        #dbus_arg{name = 'name', type = <<"s">>},
        #dbus_arg{name = 'old_owner', type = <<"s">>},
        #dbus_arg{name = 'new_owner', type = <<"s">>}
    ],
    out_sig = <<"sss">>,
    out_types = [string, string, string]
}).

-define(DBUS_DBUS_NAME_LOST, #dbus_signal{
    name = 'NameLost',
...
-define(DBUS_DBUS_NAME_ACQUIRED, #dbus_signal{
    name = 'NameAcquired',
    args = [#dbus_arg{name = 'name', type = <<"s">>}],
    out_sig = <<"s">>,
    out_types = [string]
...
-define(DBUS_DBUS_START_SERVICE_BY_NAME, #dbus_method{
    name = 'StartServiceByName',
    args = [
        #dbus_arg{name = 'name', direction = in, type = <<"s">>},
...
-define(DBUS_DBUS_UPDATE_ACTIVATION_ENVIRONMENT, #dbus_method{
...
-define(DBUS_DBUS_GET_NAME_OWNER, #dbus_method{
    name = 'GetNameOwner',
    args = [#dbus_arg{name = 'name', direction = in, type = <<"s">>}],
    result = #dbus_arg{direction = out, type = <<"s">>},
    in_sig = <<"s">>,
...
-define(DBUS_DBUS_GET_CONNECTION_UNIX_USER, #dbus_method{
...
-define(DBUS_DBUS_GET_CONNECTION_PROCESS_ID, #dbus_method{
    name = 'GetConnectionProcessID',
    args = [#dbus_arg{name = 'bus_name', direction = in, type = <<"s">>}],
    result = #dbus_arg{direction = out, type = <<"u">>},
    in_sig = <<"s">>,
    in_types = [string]
...
-define(DBUS_DBUS_GET_CONNECTION_CREDENTIALS, #dbus_method{
...
-define(DBUS_DBUS_GET_ADT_AUDIT_SESSION_DATA, #dbus_method{
...
-define(DBUS_DBUS_GET_CONNECTION_SELINUX_SECURITY_CONTEXT, #dbus_method{
...
-define(DBUS_DBUS_ADD_MATCH, #dbus_method{
    name = 'AddMatch',
...
-define(DBUS_DBUS_REMOVE_MATCH, #dbus_method{
    name = 'RemoveMatch',
    args = [#dbus_arg{name = 'rule', direction = in, type = <<"s">>}],
    in_sig = <<"s">>,
    in_types = [string]
...
-define(DBUS_DBUS_GET_ID, #dbus_method{
    name = 'GetId',
    args = [],
    result = #dbus_arg{direction = out, type = <<"s">>},
    in_sig = <<>>,
...
-define(DBUS_DBUS_REQUEST_NAME, #dbus_method{
    name = 'RequestName',
    args = [
        #dbus_arg{direction = in, type = <<"s">>},
...
-define(DBUS_DBUS_RELEASE_NAME, #dbus_method{
    name = 'ReleaseName',
    args = [
        #dbus_arg{direction = in, type = <<"s">>},
        #dbus_arg{direction = out, type = <<"u">>}
